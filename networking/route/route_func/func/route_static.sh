...
rlPhaseStartTest "Route_Selector $TEST_TYPE $TEST_TOPO $ROUTE_MODE"
	...
	do
		...
		rlRun "vrun $C_HOSTNAME ip -$version route list table 11"
		rlRun "vrun $C_HOSTNAME ip -$version route list table 256"
		rlRun "vrun $C_HOSTNAME ip -$version route list table 1111"
