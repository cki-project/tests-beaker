...
rlPhaseStartSetup
    ...
    rlRun "gcc -I /mnt/tests/kernel/networking/sctp/lib -o api_tests /mnt/tests/kernel/networking/sctp/lib/sctp_utilities.c test_sctp_sockopts.c test_cases.c api_tests.c -lsctp" 0
rlPhaseEnd
